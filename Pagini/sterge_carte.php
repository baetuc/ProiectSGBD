...
<html>
  ...
  $stmt = oci_parse($connection, 'BEGIN CRUD.sterge_carte(:ISBN); END;');
  if (!$stmt) {
  ...
  $pagina_finala = $inceput . '<div><a href = "pagina_principala.php"> Înapoi</a></div>' . '<h3> Cartea a fost ștearsă cu succes.</h3>';
